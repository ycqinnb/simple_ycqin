...
public class DimRegister {
    ...
    public DimRegister() {
        ...
        mirageDim = DimensionType.register("mirage", "_mirage", 789122,
                MirageWorldProvider.class, false);
    }
}
